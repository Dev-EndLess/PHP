...
/*
  From PHP 5 onwards you can write PHP in either a procedural or object oriented way. OOP consists of classes that can hold "properties" and "methods". Objects can be created from classes.
*/
...
$user00 = new User('Endless', 'endless@gmail.com', '123456');
echo $user00->getName();
echo '</br>';
echo $user00->getEmail();
echo '</br>';
echo $user00->login();
echo '</br>';
print_r($user00);
...
$employee00 = new employee('John','johndoe@gmail.com','123456','Manager');
echo $employee00->getTitle();